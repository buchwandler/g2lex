...
def run(
    ...
    *,
    ...
    if selector == "v2":
        ...
        base_build = build_implicit_lexicon(source, rules=rules, max_components=max_components, max_states=max_states, linkers=linker_table, recursive_components=recursive_components, max_recursive_depth=max_recursive_depth, segmentation_scorer=scorer)
